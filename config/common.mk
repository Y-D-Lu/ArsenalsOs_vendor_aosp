...
PRODUCT_COPY_FILES += \
    vendor/aosp/prebuilt/common/etc/init/init.arsenalsos-updater.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.arsenalsos-updater.rc
